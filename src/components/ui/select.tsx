  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 /min-w-[8rem] /rounded-md relative z-50 max-h-(--radix-select-content-available-height) origin-(--radix-select-content-tranfform-origin) overflow-x-hidden overflow-y-auto border shadow-md",
          position === "popper" &&
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "cursor-pointer data-[selected=true]:bg-gray-300",
        className,
      )}
      {...props}
    >
